...
\byustylesetup{%
   ...
   % nolistoftables = true,     % Don't show the List of Tables
    ...
    keywords = {state estimation, error state, multirotor, micro air vehicle,
      linear quadratic regulator, LQR, UAV, precision landing} % Enter your keywords
...
\newcommand{\appendixcitation}[2]{\chapter[#1]{#1\footnote{#2}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
